...
class HomePagePortraitLayout extends StatelessWidget {
  const HomePagePortraitLayout({super.key});
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Text(
                    ...
                    style: TextStyle(fontSize: 24, fontFamily: 'PlaywriteCU', color: Colors.white),
            ...
            child: Container(
              ...
              child: Text(
                'Experience Culinary Excellence in Every Bite. At Classic Eats, '
                    ...
                    'with us today!',
                style: TextStyle(fontSize: 16, color: Theme.of(context).colorScheme.inverseSurface), // Set text color based on theme
                textAlign: TextAlign.center,
              ),
            ),
          ),
