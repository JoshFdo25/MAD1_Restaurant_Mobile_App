...
class Product {
  ...
  final String ingredients; // New field for ingredients
...
class MenuPagePortraitLayout extends StatelessWidget {
  const MenuPagePortraitLayout({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Products List
          SizedBox(
            height: 300, // Set a height for the product list
