...
class LoginScreenLandscapeLayout extends StatefulWidget {
  final Function onLogin;
  final Function onSkip; // Callback for skipping login

  const LoginScreenLandscapeLayout({
    super.key,
  ...
  @override
  _LoginScreenLandscapeLayoutState createState() =>
      _LoginScreenLandscapeLayoutState();
}

class _LoginScreenLandscapeLayoutState extends State<LoginScreenLandscapeLayout> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          SingleChildScrollView( // Make the form scrollable
            child: Center(
              child: Padding(
